...
public class RemoveControlFlag {
    ...
    public boolean exist_v1(final String nameToFind) {
        boolean found = false;
    ...
    public boolean exist_v11(final String nameToFind) {
        boolean found = false;
    ...
    public boolean exist_v2(final String nameToFind) {
        for (String name : names) {
            if (name.equals(nameToFind)) {
                return true;
            }
    ...
    // @formatter:off
	public boolean exist_v3(final String nameToFind) {
		for (String name : names) {
			if (name.equals(nameToFind)) {
                return true;
            }
